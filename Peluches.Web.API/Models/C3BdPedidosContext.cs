...
public partial class C3BdPedidosContext : DbContext
{
    public C3BdPedidosContext()
    {
    }

    public C3BdPedidosContext(DbContextOptions<C3BdPedidosContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Initial Catalog=C3_BD_PEDIDOS;User Id=sa;Password=!sql2019;TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cargo>(entity =>
        {
            entity.HasKey(e => e.IdCargo).HasName("_copy_2");
        ...
        {
            entity.HasKey(e => e.IdCliente).HasName("_copy_5");
        ...
        {
            entity.HasKey(e => e.IdComprobante).HasName("PK__Comproba__7DE63600B992AC64");
            ...
            entity.HasOne(d => d.IdPedidoNavigation).WithMany(p => p.Comprobantes)
        ...
        {
            entity.HasKey(e => e.IdDetalle).HasName("PK__Detalle___B3E0CED32A3ED908");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("_copy_1");
        ...
        {
            entity.HasKey(e => e.IdMarca).HasName("PK__Marca__9B8F8DB272424C7A");
        ...
        {
            entity.HasKey(e => e.IdModelo).HasName("PK__Modelo__813C23720248D140");
        ...
        {
            entity.HasKey(e => e.IdPedido).HasName("_copy_3");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("_copy_4");
        ...
        {
            entity.HasKey(e => e.IdProveedor).HasName("PK__Proveedo__7D65272FDFF0C1AB");
